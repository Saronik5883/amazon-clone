      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
                ...
                items: widget.product.images.map((i) {
                  return Builder(
                    builder: (BuildContext context) => Image.network(
                      i, fit: BoxFit.contain, height: 200,
                    ),
                  );
                }).toList(),
            ...
            Padding(
                padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 20).copyWith(top: 0),
                child: Text(
                  widget.product.name,
            ...
            Padding(
              padding: const EdgeInsets.all(8.0),
              child: Text(widget.product.description, style : const TextStyle(fontSize: 17)),
            ),
            Container(
              color: Colors.black12,
              height: 5,
            ...
            //a list of the images of the product
            ListView.builder(
              shrinkWrap: true,
            ...
            productList == null ? const Text('No Products found :(') : Column(
              children: [
                Container(
